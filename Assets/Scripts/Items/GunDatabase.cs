...
public class GunDatabase : MonoBehaviour{
    ...
    private void Awake() {
        ...
        //Pistols
        GunCatalog.Add(new GunType("Pistol", "It's a simple pistol", ++id, false, 12, 120, 12, 120, 0.3f, 1, 0.4f, 0.3f, 0.02f, 0.01f, 50, 40, 1, 0.05f, "GunIcons/Pistol", "Guns/Pistol", ""));

        //ShotGuns
        GunCatalog.Add(new GunType("Mossberg", "It's a ShotGun", ++id, false, 2, 60, 2, 60, 0.9f, 2, 1, 0.8f, 0.05f, 0.1f, 50, 30, 5, 0, "GunIcons/ShotGun", "Guns/Mossberg", ""));

        //Pulse Rifles
        GunCatalog.Add(new GunType("Pulse Rifle", "Shoots a burst of rounds", ++id, false, 8, 160, 8, 160, 0.6f, 2, 1, 0.8f, 0.04f, 0.05f, 50, 35, 3, 0.05f, "GunIcons/AK", "", ""));

        //Auto Rifles
        GunCatalog.Add(new GunType("MP5", "Shoots a constant stream of bullets.", ++id, true, 30, 300, 30, 300, 0.4f, 2, 0.1f, 0.1f, 0.03f, 0.05f, 50, 25, 1, 0.05f, "GunIcons/AK", "Guns/MP5", ""));
    }
