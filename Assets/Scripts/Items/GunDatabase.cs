...
public class GunDatabase : MonoBehaviour{
    ...
    private void Awake() {
        ...
        //ShotGuns
        GunCatalog.Add(new GunType("Mossberg", "It's a ShotGun", ++id, false, 2, 60, 2, 60, 0.9f, 2, 1, 0.8f, 0.05f, 0.1f, 40, 25, 8, 0, "GunIcons/ShotGun", "Guns/Mossberg", ""));
        ...
        //Auto Rifles
        GunCatalog.Add(new GunType("MP5", "Shoots a constant stream of bullets.", ++id, true, 30, 300, 30, 300, 0.4f, 2, 0.1f, 0.1f, 0.03f, 0.05f, 50, 30, 1, 0.05f, "GunIcons/AK", "Guns/MP5", ""));
    }
